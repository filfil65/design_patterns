...
# # You could use Composite here, but maybe there needs to be a distinction between Child and Composite.
# Otherwise, Child could also be a composite object - a proper tree structure.
